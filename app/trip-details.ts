...
export const dayGuides: DayGuide[] = [
  ...
  },
  {
    ...
    rhythm: ["青皮林与海岸慢走", "海边书屋停留", "兴隆市场与老味午饭", "午后回君悦休息"],
    foodStops: [researchedFood({
  ...
  },
  {
    ...
    rhythm: ["万宁退房", "正规码头看船流与渔排", "海况允许才乘船", "午饭后单向南下清水湾"],
    foodStops: [researchedFood({
