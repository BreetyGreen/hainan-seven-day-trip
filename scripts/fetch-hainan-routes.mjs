...
const plans = {
  a: [
    ...
    drive(1, "A-D1-drive", "海口美兰 → 海口万豪", [points.haikouAirport, points.haikouMarriott]),
    walk(1, "A-D1-walk", "海口万豪 → 西海岸 → 海口万豪", [points.haikouMarriott, points.haikouCoast, points.haikouMarriott], 1.2, 18),
    drive(2, "A-D2-drive", "海口西海岸 → 万宁神州半岛君悦", [points.haikouMarriott, points.wanningHyatt]),
    walk(2, "A-D2-walk", "君悦 → 神州半岛海岸 → 君悦", [points.wanningHyatt, points.shenzhouCoast, points.wanningHyatt], 1.5, 24),
    drive(3, "A-D3-drive", "君悦 → 石梅湾 → 兴隆市场 → 君悦", [points.wanningHyatt, points.shimeiBay, points.xinglongMarket, points.wanningHyatt]),
    drive(4, "A-D4-drive", "万宁 → 新村港 → 清水湾", [points.wanningHyatt, points.xincunPort, points.clearwaterIndigo]),
    walk(5, "A-D5-walk", "清水湾英迪格 → 酒店海岸 → 英迪格", [points.clearwaterIndigo, points.clearwaterCoast, points.clearwaterIndigo], 1.5, 20),
    drive(6, "A-D6-drive", "清水湾 → 三亚国际免税城", [points.clearwaterIndigo, points.cdfSanya]),
    drive(6, "A-D6-drive-return", "三亚国际免税城 → 清水湾", [points.cdfSanya, points.clearwaterIndigo]),
    drive(7, "A-D7-drive", "清水湾 → 三亚凤凰机场", [points.clearwaterIndigo, points.sanyaAirport]),
  ...
  b: [
    ...
    drive(1, "B-D1-drive", "海口美兰 → 西海岸假日", [points.haikouAirport, points.haikouHoliday]),
    walk(1, "B-D1-walk", "西海岸假日 → 西海岸 → 西海岸假日", [points.haikouHoliday, points.haikouCoast, points.haikouHoliday], 1.4, 24),
    drive(2, "B-D2-drive", "海口西海岸 → 万宁神州半岛假日", [points.haikouHoliday, points.wanningHoliday]),
    walk(2, "B-D2-walk", "万宁假日 → 神州半岛海岸 → 万宁假日", [points.wanningHoliday, points.shenzhouCoast, points.wanningHoliday], 1.2, 24),
    drive(3, "B-D3-drive", "万宁假日 → 兴隆热带植物园 → 兴隆市场 → 万宁假日", [points.wanningHoliday, points.xinglongGarden, points.xinglongMarket, points.wanningHoliday]),
    drive(4, "B-D4-drive", "万宁神州半岛 → 陵水土福湾三正月", [points.wanningHoliday, points.sangemMoon]),
